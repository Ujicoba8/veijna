...
(function () {
  ...
  style.textContent = `
    ...
    #hch-panel {
      position: fixed; top: 20px; right: 20px; width: 280px; z-index: 999999;
      background: #0d0d0d; border: 1px solid #c9a84c; border-radius: 10px;
    ...
    .hch-btn {
      background: transparent; border: 1px solid #c9a84c33; color: #c9a84c;
    ...
    .hch-mode-btn {
      ...
      border: 1px solid #333; background: #111; color: #666; transition: all 0.15s;
    }
